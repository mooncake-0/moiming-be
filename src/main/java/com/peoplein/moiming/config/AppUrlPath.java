...
public abstract class AppUrlPath {
    ...
    public final static String API_MOIM = "/moim";
    public final static String API_MOIM_POST = "/post";
    public final static String API_MOIM_POST_COMMENT = "/comment";
    ...
    public final static String API_MOIM_MEMBER = "/moimMember";
    ...
    public final static String API_POLICY_VER = "/v0";
    public final static String API_POLICY = "/policy";
}
