...
public interface MoimPostRepository {
    ...
    Optional<MoimPost> findWithMoimAndMemberAndInfoById(Long moimPostId); // 게시물 생성자와 모임정보를 같이 불러온다

    List<MoimPost> findByMoimId(Long moimId);
    List<MoimPost> findWithMemberAndInfoByCategoryAndLastPostOrderByDateDesc(Long moimId, MoimPost moimPost, MoimPostCategory category, int limit, boolean hasPrivateVisibility);
