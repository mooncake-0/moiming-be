...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
        ...
        try {
            ...
            */
                ...
                if (StringUtils.hasText(uid)) {
                    ...
                    String resetAccessToken = moimingTokenProvider.generateToken(MoimingTokenType.JWT_AT, securityMember);
                    response.addHeader(JwtPropertySetting.HEADER_AT, resetAccessToken);
                    response.addHeader(JwtPropertySetting.HEADER_RT, securityMember.getMember().getRefreshToken());
            ...
            */
                ...
                if (StringUtils.hasText(jwtToken)) {
                    ...
                    if (StringUtils.hasText(uid)) {
                        ...
                        SecurityMember securityMember = (SecurityMember) userDetailsService.loadUserByUsername(uid);
                        JwtAuthenticationToken authenticationToken = new JwtAuthenticationToken(securityMember.getMember(), null, securityMember.getAuthorities());
                        SecurityContextHolder.getContext().setAuthentication(authenticationToken);
    ...
    private String checkRefreshTokenHeader(HttpServletRequest request) {
        ...
        return (String) request.getHeader(JwtPropertySetting.HEADER_RT);
    }
